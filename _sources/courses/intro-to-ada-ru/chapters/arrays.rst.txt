...
(:ref:`перечислимые типы <Intro_Ada_Ru_EnumTypes>`).
Скоро мы увидим, что это значит.
...
о :ref:`агрегатах типов <Intro_Ada_Ru_Aggregates>`.
...
.. _Intro_Ada_Ru_UnconstrainedArrayTypes:
...
.. attention::
    ...
    использовать :ref:`Unbounded Strings <Intro_Ada_Ru_UnboundedStrings>` из
...
.. _Intro_Ada_Ru_Object_Renaming:

Переименование
--------------

До сих пор мы видели, что следующие элементы могут быть переименованы:
:ref:`подпрограммы <Intro_Ada_Ru_Subprogram_Renaming>`,
:ref:`пакеты <Intro_Ada_Ru_Package_Renaming>`
и :ref:`компоненты записи <Intro_Ada_Ru_Record_Comp_Renaming>`. Мы также можем
...
:ref:`ранее в курсе <Intro_Ada_Ru_SubtypeAliases>`.
