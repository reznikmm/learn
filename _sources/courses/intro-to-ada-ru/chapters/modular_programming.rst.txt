...
.. _Intro_Ada_Ru_Package_Renaming:

Переименование
--------------

Ранее мы упоминали, что
:ref:`подпрограммы можно переименовывать <Intro_Ada_Ru_Subprogram_Renaming>`.
